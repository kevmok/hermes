          ...
          <div className="flex items-start justify-between mb-6">
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                <div className="relative">
                  ...
                  <div className="relative flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-cyan-500/20 to-purple-500/20 border border-cyan-500/30 shadow-lg shadow-cyan-500/10">
                    <HugeiconsIcon icon={Activity03Icon} size={24} className="text-cyan-400" />
                  </div>
                </div>
                <div>
              ...
              <p className="text-muted-foreground max-w-lg">
                Signals triggered by whale trades <span className="text-cyan-400 font-semibold">$500+</span>,
...
function StatCard({ label, value, icon: Icon, gradient, delay, isLoading, highlight }: StatCardProps) {
  return (
    <div
    ...
    >
      ...
      <div className="relative p-4">
        <div className="flex items-center justify-between mb-2">
          ...
          <div className={`p-1.5 rounded-lg bg-gradient-to-br ${gradient} opacity-80`}>
        ...
        {isLoading ? (
          ...
          <div className="flex items-baseline gap-1">
            <span className={`text-2xl font-bold tabular-nums tracking-tight ${highlight ? 'text-emerald-400' : 'text-white'}`}>
              {value}
            </span>
          </div>
        )}
